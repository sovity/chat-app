...
export const mockChats: Chat[] = [
  {
    ...
    messages: [
      ...
      {
        id: "msg-2",
        content: "The shipment #CX-45678 is currently in transit and expected to arrive on May 15th.",
        sender: "system",
      ...
      {
        id: "msg-4",
        content: "No delays have been reported. The shipment is on schedule according to the Catena-X tracking system.",
        sender: "system",
